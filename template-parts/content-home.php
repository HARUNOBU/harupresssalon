...
<section id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="entry-post">
		<div class="entry-edit clearfix">
			<?php edit_post_link( __( 'Edit', 'harupress' ), '<span class="post-edit">', '</span>' ); ?>
		</div>
		<?php 
		...
		<header class="entry-header">
			...
			<div class="entry-category"><?php echo "category by "; the_category(', ') ?></div>			
		</header><!-- .entry-header -->
